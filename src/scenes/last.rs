...
use crate::shape::{
	Shape, shape_list::ShapeList, cube::Cube, bvh_node::BvhNode, xz_rect::XzRect,
	moving_sphere::MovingSphere, sphere::Sphere, constant_medium::ConstantMedium,
	translate::Translate, rotate_y::RotateY,
};
use crate::material::{
	Material, lambertian::Lambertian, diffuse_light::DiffuseLight, dielectric::Dielectric,
	metal::Metal,
};
use crate::vec3::{Point3, Color, Vec3};
use crate::texture::{Texture, image::Image, perlin::Perlin};
...
pub fn build(rng: &mut ThreadRng) -> ShapeList {
	...
	for i in 0..BOXES_PER_SIDE {
		for j in 0..BOXES_PER_SIDE {
			...
			boxes1.add(Rc::new(Cube::new(
				Point3::new(x0, y0, z0), Point3::new(x1, y1, z1), Rc::clone(&ground),
			)));
		}
	}
	...
	shapes.add(Rc::new(XzRect::new(123.0, 423.0, 147.0, 412.0, 554.0, light)));

	let center1 = Point3::new(400.0, 400.0, 200.0);
	let center2 = center1 + Vec3::new(30.0, 0.0, 0.0);
	let material: Rc<dyn Material> = Rc::new(Lambertian::from_color(Color::new(0.7, 0.3, 0.1)));
	shapes.add(Rc::new(MovingSphere::new(center1, center2, 0.0, 1.0, 50.0, material)));
	...
	shapes.add(Rc::new(ConstantMedium::from_color(boundary, 0.0001, Color::new(1.0, 1.0, 1.0))));
	...
	for _ in 0..N {
		boxes2.add(Rc::new(
			Sphere::new(Point3::rand_between(0.0, 165.0, rng),
			10.0,
			Rc::clone(&white),
		)));
	}
	...
	shapes.add(Rc::new(Translate::new(
		Rc::new(RotateY::new(
			Rc::new(BvhNode::new(boxes2, 0.0, 1.0, rng)), 15.0,
		)),
